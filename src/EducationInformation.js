    ...
    <div>
      <form onSubmit = {handleSubmit(onSubmit)}> 
        ...
        <Box
          ...
          <Typography  color = "error" fontWeight = "bold" variant = "h4" > Education Infomation </Typography>
          </Box>


          {/* Professional Component */}
          <Box margin={'auto'} flexWrap={"wrap"} >
          <Typography sx = {{mr : {Bigmobile : 0.75} , mt : {smallmobile : 0.25 , mobile : 1} , justifyContent : {smallmobile : 'flex-start' , Bigmobile : 'center'} , fontSize : {mobile : '19px' , Bigmobile : '22px'} }} alignItems={"center"} display = "flex" flexWrap={"wrap"} fontWeight = {"bold"} >Professional:
          ...
          <Box>
          <CssTextField autoComplete='no' {...register("professional")} type = "text" label="Professional" fullWidth
          ...
          <Box color = {'red'} fontSize = {"14px"} fontWeight = "bold">{errors.professional ? errors.professional?.message : null}</Box>
           ...
           {/* Education Component */}
           <Box margin = "auto" flexWrap={"wrap"} >
          <Typography sx = {{ml : {smallmobile : 2 , mobile : 2.5 , Bigmobile : 2.5 , tablet : 2.5} , mt : {smallmobile : 0} , justifyContent : {smallmobile : 'flex-start' , Bigmobile : 'center'} , fontSize : {mobile : '19px' , Bigmobile : '22px'} , alignItems : {Bigmobile : 'center'} }} display = "flex" flexWrap={"wrap"} fontWeight = {"bold"}>Education:
          <Typography fontWeight = {"bold"} variant = "h5" color = "error">*</Typography>
          ...
          <Box>
          <CssTextField autoComplete='no' sx = {{ mt : {smallmobile : 1.25} , width : {smallmobile : 202 , mobile : 258 , Bigmobile : 215 , tablet : 208} }} {...register("studyProgram")} type = "text" label="Study Program"></CssTextField>
          <Box color = {'red'} fontSize = {"14px"} fontWeight = "bold">{errors.studyProgram ? errors.studyProgram?.message : null}</Box>
          </Box>
          <Box>
          <CssTextField autoComplete='no' sx = {{ mt : {smallmobile : 1.25} , width : {smallmobile : 202 , mobile : 258 , Bigmobile : 215 , tablet : 208} , ml : {tablet : 1.5} }} {...register("iopoe")} type = "text" label="Institution or Place of Education"></CssTextField>
          ...
          <Box sx = {{display : {Bigmobile : 'flex'}}} flexWrap = {"wrap"} justifyContent = {"center"}>
          <Box>
          <CssTextField autoComplete='no' sx = {{ width : {smallmobile : 202 , mobile : 258 , Bigmobile : 125 , tablet : 120} , mt : {smallmobile : 1.25} }} {...register("city2")} type = "text" label="City"></CssTextField>
          <Box color = {'red'} fontSize = {"14px"} fontWeight = "bold">{errors.city2 ? errors.city2?.message : null}</Box>
          </Box>
          <Box>
          <CssTextField autoComplete='no' sx = {{ width : {smallmobile : 202 , mobile : 258 , Bigmobile : 125 , tablet : 120} , ml : {tablet : 1.5} , mt : {smallmobile : 1.25} }} {...register("country")} type = "text" label="Country"></CssTextField>
          <Box color = {'red'} fontSize = {"14px"} fontWeight = "bold">{errors.country ? errors.country?.message : null}</Box>
          </Box>
          <Box>
          <CssTextField autoComplete='no' sx = {{ width : {smallmobile : 150 , mobile : 205 , Bigmobile : 125 , tablet : 120} , ml : {tablet : 1.5} , mt : {smallmobile : 1.25} }} {...register("gpa")} type = "number" label="GPA"></CssTextField>
          <IconButton sx = {{ mt : {smallmobile : 1.5} }} onClick = {() => handleAddEducation()} aria-label="Add" size = "large" color = 'primary'> <AddCircleOutlineIcon fontSize="inherit" /> </IconButton>
        ...
        return(
          ...
          <Box>
          <Button onClick={()=> navigate('/PersonalInformation')} variant="contained" color="success">
            Previous
          </Button>
          </Box>
          <Box sx = {{ ml : {smallmobile : 2}}}>
          
          <Button type = 'submit' variant="contained" color="success" onClick={()=> navigate('/WorkExperience')}>
            Next
          </Button>
          </Box>
          </Box>
